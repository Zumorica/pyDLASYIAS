...
import pyDLASYIAS.multiplayer.guard as guardMain
import pyDLASYIAS.multiplayer.chicken as chickenMain
...
def launcher():
    ...
    timeright = sprite.Sprite(
        startpos=(311, 560), image="launcher\\buttons\\1")
    timeright.groups = group

    power = 100
    powerleft = sprite.Sprite(
        startpos=(406, 560), image="launcher\\buttons\\0")
    powerleft.groups = group

    powerright = sprite.Sprite(
        startpos=(593, 560), image="launcher\\buttons\\1")
    ...
    bearspr = sprite.Sprite(
        startpos=(118, 187), image="launcher\\animatronics\\b")
    ...
    bearright = sprite.Sprite(
        startpos=(311, 470), image="launcher\\buttons\\1")
    bearright.groups = group

    rabbitspr = sprite.Sprite(
        startpos=(403, 187), image="launcher\\animatronics\\r")
    rabbitspr.groups = group

    rabbitai = 0

    rabbitleft = sprite.Sprite(
        startpos=(406, 470), image="launcher\\buttons\\0")
    rabbitleft.groups = group

    rabbitright = sprite.Sprite(
        startpos=(593, 470), image="launcher\\buttons\\1")
    rabbitright.groups = group

    chickenspr = sprite.Sprite(
        startpos=(682, 187), image="launcher\\animatronics\\c")
    chickenspr.groups = group

    chickenai = 0

    chickenleft = sprite.Sprite(
        startpos=(690, 470), image="launcher\\buttons\\0")
    chickenleft.groups = group

    chickenright = sprite.Sprite(
        startpos=(876, 470), image="launcher\\buttons\\1")
    chickenright.groups = group

    foxspr = sprite.Sprite(
        startpos=(957, 187), image="launcher\\animatronics\\f")
    foxspr.groups = group
    ...
    foxright = sprite.Sprite(
        startpos=(1154, 470), image="launcher\\buttons\\1")
